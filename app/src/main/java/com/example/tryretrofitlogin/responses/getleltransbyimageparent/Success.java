package com.example.tryretrofitlogin.responses.getleltransbyimageparent;
...
public class Success{
	...
	public void setHargaLelang(int hargaLelang){
		this.hargaLelang = hargaLelang;
	}

	public int getHargaLelang(){
		return hargaLelang;
	}
